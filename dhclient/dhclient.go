...
func setNameServers(entry, configpath, configpathbackup string) (err error) {
...
func AddNameServers(addrs []string, configpath, configpathbackup string) (err error) {
	...
	err = setNameServers(fmt.Sprintf(dhclientNameServers, strings.Join(addrs, ", ")), configpath, configpathbackup)
...
func RemoveNameServers(configpath, configpathbackup string) (err error) {
	return setNameServers("", configpath, configpathbackup)
}
